...
| [0005](0005-service-to-service-feed-credential.md) | The service-to-service feed credential: one per (consumer, publisher) pair per deployment, generated at composition time, hashed allow-list on the publisher, scoped to `GET /events` and nothing else (satisfies auth ADR-0019 condition 2, closes W1) | Proposed |
